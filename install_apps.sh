...
# 定义目标程序
# 格式: "程序名,源文件"
TARGETS="cat,prog/prog/cat.c echo,prog/prog/echo.c prog_pipe,prog/prog/prog_pipe.c shell,prog/shell/shell.c hd,prog/prog/hexdump.c mkfs,prog/prog/mkfs.c"
